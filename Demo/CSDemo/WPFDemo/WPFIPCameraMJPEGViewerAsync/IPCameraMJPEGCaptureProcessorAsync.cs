...
namespace WPFIPCameraMJPEGViewerAsync
{
    ...
    class IPCameraMJPEGCaptureProcessorAsync : ICaptureProcessor
    {
        ...
        private IPCameraMJPEGCaptureProcessorAsync() { }
        ...
        static async public System.Threading.Tasks.Task<ICaptureProcessor> createCaptureProcessor()
        {
            ...
            return await System.Threading.Tasks.Task.Run(() =>
            {
                ...
                IPCameraMJPEGCaptureProcessorAsync lICaptureProcessor = new IPCameraMJPEGCaptureProcessorAsync();


                {
                    HttpWebRequest req = (HttpWebRequest)WebRequest.Create(IPCameraMJPEGCaptureProcessorAsync.mURL);
